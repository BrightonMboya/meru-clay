 ...
 * One payment.
 *
 * Never indexed and never listed: the URL contains a UUID, which is the only
 * thing standing between a stranger and somebody's money. Same reasoning,
 * and the same `robots` block, as /book/[id].
 */
